...
namespace AssetInsight.Data.Migrations
{
    ...
    [Migration("20260419150157_moreFixes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetInsight.Data.Models.Follow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AssetInsight.Data.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AssetInsight.Data.Models.TradingStrategy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 4, 19, 15, 1, 55, 382, DateTimeKind.Utc).AddTicks(6395),
                            DefinitionJson = "{\r\n				    \"type\": \"Condition\",\r\n				    \"indicator\": \"RSI\",\r\n				    \"period\": 14,\r\n				    \"operator\": \"<\",\r\n				    \"value\": 30\r\n				}",
            ...
            modelBuilder.Entity("AssetInsight.Data.Models.WatchList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AssetInsight.Data.Models.Follow", b =>
                {
                    b.HasOne("AssetInsight.Data.Models.User", "FollowedUser")
                        .WithMany("Followers")
                        .HasForeignKey("FollowedUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AssetInsight.Data.Models.User", "Follower")
                        .WithMany("Following")
